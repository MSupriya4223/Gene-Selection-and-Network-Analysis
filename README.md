...
**Variance Filtering:** First, I kept only genes with high variability (variance > 0.04) since they are more likely to be biologically relevant.
...
**Volcano Plot:** Then, I looked for genes with significant changes in expression (-log10 p-value > 10 and |logFC| > 1).
